        ...
        <div class="card bg-primary text-white shadow">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-uppercase mb-1">Provinsi</div>
                        <div class="h5 mb-0 font-weight-bold">{{ $totalProvinsi }}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-footer bg-primary text-white clearfix small z-1">
                <a href="{{ route('provinsi.index') }}" class="text-white float-left">More info</a>
